...
namespace Bungie\D1\Model\Destiny\Components\PlugSets;
 ...
 * @link     https://openapi-generator.tech
 */
class DestinyPlugSetsComponent implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'plugs' => 'map[string,\Bungie\D1\Model\Destiny\Sockets\DestinyItemPlug[]]'
    ];
     ...
     * Gets plugs
     *
     * @return map[string,\Bungie\D1\Model\Destiny\Sockets\DestinyItemPlug[]]|null
     */
     ...
     * Sets plugs
     *
     * @param map[string,\Bungie\D1\Model\Destiny\Sockets\DestinyItemPlug[]]|null $plugs The shared list of plugs for each relevant PlugSet, keyed by the hash identifier of the PlugSet (DestinyPlugSetDefinition).
     *
     * @return $this
     */
