...
namespace Bungie\D1\Model\Destiny\Components\Kiosks;
 ...
 * @link     https://openapi-generator.tech
 */
class DestinyKiosksComponent implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'kioskItems' => 'map[string,\Bungie\D1\Model\Destiny\Components\Kiosks\DestinyKioskItem[]]'
    ];
     ...
     * Gets kioskItems
     *
     * @return map[string,\Bungie\D1\Model\Destiny\Components\Kiosks\DestinyKioskItem[]]|null
     */
     ...
     * Sets kioskItems
     *
     * @param map[string,\Bungie\D1\Model\Destiny\Components\Kiosks\DestinyKioskItem[]]|null $kioskItems A dictionary keyed by the Kiosk Vendor's hash identifier (use it to look up the DestinyVendorDefinition for the relevant kiosk vendor), and whose value is a list of all the items that the user can \"see\" in the Kiosk, and any other interesting metadata.
     *
     * @return $this
     */
