...
namespace Bungie\D1\Model\Destiny\Components\Presentation;
 ...
 * @link     https://openapi-generator.tech
 */
class DestinyPresentationNodeComponent implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'state' => '\Bungie\D1\Model\Destiny\DestinyPresentationNodeState',
        'objective' => '\Bungie\D1\Model\Destiny\Quests\DestinyObjectiveProgress',
        'progressValue' => 'int',
        'completionValue' => 'int'
    ];
     ...
     * Gets state
     *
     * @return \Bungie\D1\Model\Destiny\DestinyPresentationNodeState|null
     */
     ...
     * Sets state
     *
     * @param \Bungie\D1\Model\Destiny\DestinyPresentationNodeState|null $state state
     *
     * @return $this
     */
     ...
     * Sets objective
     *
     * @param \Bungie\D1\Model\Destiny\Quests\DestinyObjectiveProgress|null $objective An optional property: presentation nodes MAY have objectives, which can be used to infer more human readable data about the progress. However, progressValue and completionValue ought to be considered the canonical values for progress on Progression Nodes.
     *
     * @return $this
     */
