 ...
 * @link     https://openapi-generator.tech
 */
class DestinyMilestoneQuestDefinition implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'questRewards' => '\Bungie\D1\Model\Destiny\Definitions\Milestones\DestinyMilestoneQuestRewardsDefinition',
        'activities' => 'map[string,\Bungie\D1\Model\Destiny\Definitions\Milestones\DestinyMilestoneActivityDefinition]',
        'destinationHash' => 'int'
    ];
     ...
     * Gets questRewards
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\Milestones\DestinyMilestoneQuestRewardsDefinition|null
     */
     ...
     * Sets questRewards
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\Milestones\DestinyMilestoneQuestRewardsDefinition|null $questRewards The rewards you will get for completing this quest, as best as we could extract them from our data. Sometimes, it'll be a decent amount of data. Sometimes, it's going to be sucky. Sorry.
     *
     * @return $this
     */
     ...
     * Gets activities
     *
     * @return map[string,\Bungie\D1\Model\Destiny\Definitions\Milestones\DestinyMilestoneActivityDefinition]|null
     */
