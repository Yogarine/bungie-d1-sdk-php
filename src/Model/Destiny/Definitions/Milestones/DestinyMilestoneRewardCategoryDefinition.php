 ...
 * @link     https://openapi-generator.tech
 */
class DestinyMilestoneRewardCategoryDefinition implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'rewardEntries' => 'map[string,\Bungie\D1\Model\Destiny\Definitions\Milestones\DestinyMilestoneRewardEntryDefinition]',
        'order' => 'int'
    ];
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\Common\DestinyDisplayPropertiesDefinition|null $displayProperties Hopefully this is obvious by now.
     *
     * @return $this
     */
     ...
     * Gets rewardEntries
     *
     * @return map[string,\Bungie\D1\Model\Destiny\Definitions\Milestones\DestinyMilestoneRewardEntryDefinition]|null
     */
     ...
     * Sets rewardEntries
     *
     * @param map[string,\Bungie\D1\Model\Destiny\Definitions\Milestones\DestinyMilestoneRewardEntryDefinition]|null $rewardEntries If this milestone can provide rewards, this will define the sets of rewards that can be earned, the conditions under which they can be acquired, internal data that we'll use at runtime to determine whether you've already earned or redeemed this set of rewards, and the category that this reward should be placed under.
     *
     * @return $this
     */
