 ...
 * @link     https://openapi-generator.tech
 */
class DestinyTalentNodeCategory implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\Common\DestinyDisplayPropertiesDefinition|null $displayProperties Will contain at least the \"name\", which will be the title of the category. We will likely not have description and an icon yet, but I'm going to keep my options open.
     *
     * @return $this
     */
