 ...
 * @link     https://openapi-generator.tech
 */
class DestinyVendorDisplayPropertiesDefinition implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'subtitle' => 'string',
        'originalIcon' => 'string',
        'requirementsDisplay' => '\Bungie\D1\Model\Destiny\Definitions\DestinyVendorRequirementDisplayEntryDefinition[]',
     ...
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyVendorRequirementDisplayEntryDefinition[]|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyVendorRequirementDisplayEntryDefinition[]|null $requirementsDisplay Vendors, in addition to expected display property data, may also show some \"common requirements\" as statically defined definition data. This might be when a vendor accepts a single type of currency, or when the currency is unique to the vendor and the designers wanted to show that currency when you interact with the vendor.
     *
     * @return $this
     */
