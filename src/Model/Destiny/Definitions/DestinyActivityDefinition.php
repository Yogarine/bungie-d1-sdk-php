 ...
 * @link     https://openapi-generator.tech
 */
class DestinyActivityDefinition implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'originalDisplayProperties' => '\Bungie\D1\Model\Destiny\Definitions\Common\DestinyDisplayPropertiesDefinition',
        'selectionScreenDisplayProperties' => '\Bungie\D1\Model\Destiny\Definitions\Common\DestinyDisplayPropertiesDefinition',
        'releaseIcon' => 'string',
        'releaseTime' => 'int',
        'activityLevel' => 'int',
        ...
        'tier' => 'int',
        'pgcrImage' => 'string',
        'rewards' => '\Bungie\D1\Model\Destiny\Definitions\DestinyActivityRewardDefinition[]',
        'modifiers' => '\Bungie\D1\Model\Destiny\Definitions\DestinyActivityModifierReferenceDefinition[]',
        'isPlaylist' => 'bool',
        'challenges' => '\Bungie\D1\Model\Destiny\Definitions\DestinyActivityChallengeDefinition[]',
        'optionalUnlockStrings' => '\Bungie\D1\Model\Destiny\Definitions\DestinyActivityUnlockStringDefinition[]',
        'playlistItems' => '\Bungie\D1\Model\Destiny\Definitions\DestinyActivityPlaylistItemDefinition[]',
        'activityGraphList' => '\Bungie\D1\Model\Destiny\Definitions\DestinyActivityGraphListEntryDefinition[]',
        'matchmaking' => '\Bungie\D1\Model\Destiny\Definitions\DestinyActivityMatchmakingBlockDefinition',
        'guidedGame' => '\Bungie\D1\Model\Destiny\Definitions\DestinyActivityGuidedBlockDefinition',
        'directActivityModeHash' => 'int',
        'directActivityModeType' => 'int',
        'loadouts' => '\Bungie\D1\Model\Destiny\Definitions\DestinyActivityLoadoutRequirementSet[]',
        'activityModeHashes' => 'int[]',
        'activityModeTypes' => '\Bungie\D1\Model\Destiny\HistoricalStats\Definitions\DestinyActivityModeType[]',
        'isPvP' => 'bool',
        'insertionPoints' => '\Bungie\D1\Model\Destiny\Definitions\DestinyActivityInsertionPointDefinition[]',
        'activityLocationMappings' => '\Bungie\D1\Model\Destiny\Constants\DestinyEnvironmentLocationMapping[]',
        'hash' => 'int',
        'index' => 'int',
        'redacted' => 'bool'
    ];
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\Common\DestinyDisplayPropertiesDefinition|null $originalDisplayProperties The unadulterated form of the display properties, as they ought to be shown in the Director (if the activity appears in the director).
     *
     * @return $this
     */
     ...
     * Gets rewards
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyActivityRewardDefinition[]|null
     */
     ...
     * Gets modifiers
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyActivityModifierReferenceDefinition[]|null
     */
     ...
     * Gets challenges
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyActivityChallengeDefinition[]|null
     */
     ...
     * Sets challenges
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyActivityChallengeDefinition[]|null $challenges An activity can have many Challenges, of which any subset of them may be active for play at any given period of time. This gives the information about the challenges and data that we use to understand when they're active and what rewards they provide. Sadly, at the moment there's no central definition for challenges: much like \"Skulls\" were in Destiny 1, these are defined on individual activities and there can be many duplicates/near duplicates across the Destiny 2 ecosystem. I have it in mind to centralize these in a future revision of the API, but we are out of time.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyActivityUnlockStringDefinition[]|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyActivityUnlockStringDefinition[]|null $optionalUnlockStrings If there are status strings related to the activity and based on internal state of the game, account, or character, then this will be the definition of those strings and the states needed in order for the strings to be shown.
     *
     * @return $this
     */
     ...
     * Gets playlistItems
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyActivityPlaylistItemDefinition[]|null
     */
     ...
     * Sets playlistItems
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyActivityPlaylistItemDefinition[]|null $playlistItems Represents all of the possible activities that could be played in the Playlist, along with information that we can use to determine if they are active at the present time.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyActivityGraphListEntryDefinition[]|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyActivityGraphListEntryDefinition[]|null $activityGraphList Unfortunately, in practice this is almost never populated. In theory, this is supposed to tell which Activity Graph to show if you bring up the director while in this activity.
     *
     * @return $this
     */
     ...
     * Gets matchmaking
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyActivityMatchmakingBlockDefinition|null
     */
     ...
     * Sets matchmaking
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyActivityMatchmakingBlockDefinition|null $matchmaking This block of data provides information about the Activity's matchmaking attributes: how many people can join and such.
     *
     * @return $this
     */
     ...
     * Gets guidedGame
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyActivityGuidedBlockDefinition|null
     */
     ...
     * Sets guidedGame
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyActivityGuidedBlockDefinition|null $guidedGame This block of data, if it exists, provides information about the guided game experience and restrictions for this activity. If it doesn't exist, the game is not able to be played as a guided game.
     *
     * @return $this
     */
     ...
     * Gets loadouts
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyActivityLoadoutRequirementSet[]|null
     */
     ...
     * Sets loadouts
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyActivityLoadoutRequirementSet[]|null $loadouts The set of all possible loadout requirements that could be active for this activity. Only one will be active at any given time, and you can discover which one through activity-associated data such as Milestones that have activity info on them.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyActivityInsertionPointDefinition[]|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyActivityInsertionPointDefinition[]|null $insertionPoints The list of phases or points of entry into an activity, along with information we can use to determine their gating and availability.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\Constants\DestinyEnvironmentLocationMapping[]|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Constants\DestinyEnvironmentLocationMapping[]|null $activityLocationMappings A list of location mappings that are affected by this activity. Pulled out of DestinyLocationDefinitions for our/your lookup convenience.
     *
     * @return $this
     */
