 ...
 * @link     https://openapi-generator.tech
 */
class DestinyFactionDefinition implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'vendors' => '\Bungie\D1\Model\Destiny\Definitions\DestinyFactionVendorDefinition[]',
        'hash' => 'int',
        'index' => 'int',
        'redacted' => 'bool'
    ];
     ...
     * Gets vendors
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyFactionVendorDefinition[]|null
     */
     ...
     * Sets vendors
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyFactionVendorDefinition[]|null $vendors List of vendors that are associated with this faction. The last vendor that passes the unlock flag checks is the one that should be shown.
     *
     * @return $this
     */
