 ...
 * @link     https://openapi-generator.tech
 */
class DestinySandboxPerkDefinition implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
     ...
     * Sets damageType
     *
     * @param \Bungie\D1\Model\Destiny\DamageType|null $damageType If this perk grants a damage type to a weapon, the damage type will be defined here.  Unless you have a compelling reason to use this enum value, use the damageTypeHash instead to look up the actual DestinyDamageTypeDefinition.
     *
     * @return $this
     */
     ...
     * Sets perkGroups
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyTalentNodeStepGroups|null $perkGroups An old holdover from the original Armory, this was an attempt to group perks by functionality.  It is as yet unpopulated, and there will be quite a bit of work needed to restore it to its former working order.
     *
     * @return $this
     */
