 ...
 * @link     https://openapi-generator.tech
 */
class DestinyUnlockExpressionDefinition implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
     ...
     * Sets scope
     *
     * @param \Bungie\D1\Model\Destiny\DestinyGatingScope|null $scope A shortcut for determining the most restrictive gating that this expression performs. See the DestinyGatingScope enum's documentation for more details.
     *
     * @return $this
     */
