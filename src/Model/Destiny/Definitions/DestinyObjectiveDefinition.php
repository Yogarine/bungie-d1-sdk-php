 ...
 * @link     https://openapi-generator.tech
 */
class DestinyObjectiveDefinition implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'completionValue' => 'int',
        'scope' => '\Bungie\D1\Model\Destiny\DestinyGatingScope',
        'locationHash' => 'int',
        'allowNegativeValue' => 'bool',
        'allowValueChangeWhenCompleted' => 'bool',
        'isCountingDownward' => 'bool',
        'valueStyle' => '\Bungie\D1\Model\Destiny\DestinyUnlockValueUIStyle',
        'progressDescription' => 'string',
        'perks' => '\Bungie\D1\Model\Destiny\Definitions\DestinyObjectivePerkEntryDefinition',
        'stats' => '\Bungie\D1\Model\Destiny\Definitions\DestinyObjectiveStatEntryDefinition',
        'minimumVisibilityThreshold' => 'int',
        'allowOvercompletion' => 'bool',
        'showValueOnComplete' => 'bool',
        'completedValueStyle' => '\Bungie\D1\Model\Destiny\DestinyUnlockValueUIStyle',
        'inProgressValueStyle' => '\Bungie\D1\Model\Destiny\DestinyUnlockValueUIStyle',
        'hash' => 'int',
        'index' => 'int',
        'redacted' => 'bool'
    ];
     ...
     * Sets scope
     *
     * @param \Bungie\D1\Model\Destiny\DestinyGatingScope|null $scope A shortcut for determining the most restrictive gating that this Objective is set to use. This includes both the dynamic determination of progress and of completion values. See the DestinyGatingScope enum's documentation for more details.
     *
     * @return $this
     */
     ...
     * Gets valueStyle
     *
     * @return \Bungie\D1\Model\Destiny\DestinyUnlockValueUIStyle|null
     */
     ...
     * Sets valueStyle
     *
     * @param \Bungie\D1\Model\Destiny\DestinyUnlockValueUIStyle|null $valueStyle The UI style applied to the objective. It's an enum, take a look at DestinyUnlockValueUIStyle for details of the possible styles. Use this info as you wish to customize your UI.
     *
     * @return $this
     */
     ...
     * Gets perks
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyObjectivePerkEntryDefinition|null
     */
     ...
     * Sets perks
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyObjectivePerkEntryDefinition|null $perks If this objective enables Perks intrinsically, the conditions for that enabling are defined here.
     *
     * @return $this
     */
     ...
     * Gets stats
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyObjectiveStatEntryDefinition|null
     */
     ...
     * Sets stats
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyObjectiveStatEntryDefinition|null $stats If this objective enables modifications on a player's stats intrinsically, the conditions are defined here.
     *
     * @return $this
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\DestinyUnlockValueUIStyle|null $completedValueStyle The style to use when the objective is completed.
     *
     * @return $this
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\DestinyUnlockValueUIStyle|null $inProgressValueStyle The style to use when the objective is still in progress.
     *
     * @return $this
     */
