 ...
 * @link     https://openapi-generator.tech
 */
class DestinyEquippingBlockDefinition implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'attributes' => '\Bungie\D1\Model\Destiny\EquippingItemBlockAttributes',
        'ammoType' => '\Bungie\D1\Model\Destiny\DestinyAmmunitionType',
     ...
     * Gets attributes
     *
     * @return \Bungie\D1\Model\Destiny\EquippingItemBlockAttributes|null
     */
     ...
     * Sets attributes
     *
     * @param \Bungie\D1\Model\Destiny\EquippingItemBlockAttributes|null $attributes These are custom attributes on the equippability of the item.  For now, this can only be \"equip on acquire\", which would mean that the item will be automatically equipped as soon as you pick it up.
     *
     * @return $this
     */
     ...
     * Gets ammoType
     *
     * @return \Bungie\D1\Model\Destiny\DestinyAmmunitionType|null
     */
     ...
     * Sets ammoType
     *
     * @param \Bungie\D1\Model\Destiny\DestinyAmmunitionType|null $ammoType Ammo type used by a weapon is no longer determined by the bucket in which it is contained. If the item has an ammo type - i.e. if it is a weapon - this will be the type of ammunition expected.
     *
     * @return $this
     */
