...
namespace Bungie\D1\Model\Destiny\Definitions\Director;
 ...
 * @link     https://openapi-generator.tech
 */
class DestinyActivityGraphDefinition implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'nodes' => '\Bungie\D1\Model\Destiny\Definitions\Director\DestinyActivityGraphNodeDefinition[]',
        'artElements' => '\Bungie\D1\Model\Destiny\Definitions\Director\DestinyActivityGraphArtElementDefinition[]',
        'connections' => '\Bungie\D1\Model\Destiny\Definitions\Director\DestinyActivityGraphConnectionDefinition[]',
        'displayObjectives' => '\Bungie\D1\Model\Destiny\Definitions\Director\DestinyActivityGraphDisplayObjectiveDefinition[]',
        'displayProgressions' => '\Bungie\D1\Model\Destiny\Definitions\Director\DestinyActivityGraphDisplayProgressionDefinition[]',
        'linkedGraphs' => '\Bungie\D1\Model\Destiny\Definitions\Director\DestinyLinkedGraphDefinition[]',
        'hash' => 'int',
        'index' => 'int',
        'redacted' => 'bool'
    ];
     ...
     * Gets nodes
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\Director\DestinyActivityGraphNodeDefinition[]|null
     */
     ...
     * Sets nodes
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\Director\DestinyActivityGraphNodeDefinition[]|null $nodes These represent the visual \"nodes\" on the map's view. These are the activities you can click on in the map.
     *
     * @return $this
     */
     ...
     * Gets artElements
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\Director\DestinyActivityGraphArtElementDefinition[]|null
     */
     ...
     * Sets artElements
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\Director\DestinyActivityGraphArtElementDefinition[]|null $artElements Represents one-off/special UI elements that appear on the map.
     *
     * @return $this
     */
     ...
     * Gets connections
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\Director\DestinyActivityGraphConnectionDefinition[]|null
     */
     ...
     * Sets connections
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\Director\DestinyActivityGraphConnectionDefinition[]|null $connections Represents connections between graph nodes. However, it lacks context that we'd need to make good use of it.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\Director\DestinyActivityGraphDisplayObjectiveDefinition[]|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\Director\DestinyActivityGraphDisplayObjectiveDefinition[]|null $displayObjectives Objectives can display on maps, and this is supposedly metadata for that. I have not had the time to analyze the details of what is useful within however: we could be missing important data to make this work. Expect this property to be expanded on later if possible.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\Director\DestinyActivityGraphDisplayProgressionDefinition[]|null
     */
     ...
     * Gets linkedGraphs
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\Director\DestinyLinkedGraphDefinition[]|null
     */
     ...
     * Sets linkedGraphs
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\Director\DestinyLinkedGraphDefinition[]|null $linkedGraphs Represents links between this Activity Graph and other ones.
     *
     * @return $this
     */
