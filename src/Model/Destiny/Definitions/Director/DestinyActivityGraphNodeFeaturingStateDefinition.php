 ...
 * @link     https://openapi-generator.tech
 */
class DestinyActivityGraphNodeFeaturingStateDefinition implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'highlightType' => '\Bungie\D1\Model\Destiny\ActivityGraphNodeHighlightType'
    ];
     ...
     * Gets highlightType
     *
     * @return \Bungie\D1\Model\Destiny\ActivityGraphNodeHighlightType|null
     */
     ...
     * Sets highlightType
     *
     * @param \Bungie\D1\Model\Destiny\ActivityGraphNodeHighlightType|null $highlightType The node can be highlighted in a variety of ways - the game iterates through these and finds the first FeaturingState that is valid at the present moment given the Game, Account, and Character state, and renders the node in that state. See the ActivityGraphNodeHighlightType enum for possible values.
     *
     * @return $this
     */
