 ...
 * @link     https://openapi-generator.tech
 */
class DestinyItemCategoryDefinition implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'grantDestinyItemType' => '\Bungie\D1\Model\Destiny\DestinyItemType',
        'grantDestinySubType' => '\Bungie\D1\Model\Destiny\DestinyItemSubType',
        'grantDestinyClass' => '\Bungie\D1\Model\Destiny\DestinyClass',
     ...
     *
     * @param \Bungie\D1\Model\Destiny\DestinyItemType|null $grantDestinyItemType If an item belongs to this category, it will also receive this item type. This is now how DestinyItemType is populated for items: it used to be an even jankier process, but that's a story that requires more alcohol.
     *
     * @return $this
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\DestinyClass|null $grantDestinyClass If an item belongs to this category, it will also get this class restriction enum value.  See the other \"grant\"-prefixed properties on this definition for my color commentary.
     *
     * @return $this
     */
