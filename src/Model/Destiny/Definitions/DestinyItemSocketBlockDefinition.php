 ...
 * @link     https://openapi-generator.tech
 */
class DestinyItemSocketBlockDefinition implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'detail' => 'string',
        'socketEntries' => '\Bungie\D1\Model\Destiny\Definitions\DestinyItemSocketEntryDefinition[]',
        'intrinsicSockets' => '\Bungie\D1\Model\Destiny\Definitions\DestinyItemIntrinsicSocketEntryDefinition[]',
        'socketCategories' => '\Bungie\D1\Model\Destiny\Definitions\DestinyItemSocketCategoryDefinition[]'
    ];
     ...
     * Gets socketEntries
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyItemSocketEntryDefinition[]|null
     */
     ...
     * Sets socketEntries
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyItemSocketEntryDefinition[]|null $socketEntries Each non-intrinsic (or mutable) socket on an item is defined here. Check inside for more info.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyItemIntrinsicSocketEntryDefinition[]|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyItemIntrinsicSocketEntryDefinition[]|null $intrinsicSockets Each intrinsic (or immutable/permanent) socket on an item is defined here, along with the plug that is permanently affixed to the socket.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyItemSocketCategoryDefinition[]|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyItemSocketCategoryDefinition[]|null $socketCategories A convenience property, that refers to the sockets in the \"sockets\" property, pre-grouped by category and ordered in the manner that they should be grouped in the UI. You could form this yourself with the existing data, but why would you want to? Enjoy life man.
     *
     * @return $this
     */
