 ...
 * @link     https://openapi-generator.tech
 */
class DestinyNodeStepDefinition implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'damageType' => '\Bungie\D1\Model\Destiny\DamageType',
        'damageTypeHash' => 'int',
        'activationRequirement' => '\Bungie\D1\Model\Destiny\Definitions\DestinyNodeActivationRequirement',
        ...
        'statHashes' => 'int[]',
        'affectsQuality' => 'bool',
        'stepGroups' => '\Bungie\D1\Model\Destiny\Definitions\DestinyTalentNodeStepGroups',
        'affectsLevel' => 'bool',
        'socketReplacements' => '\Bungie\D1\Model\Destiny\Definitions\DestinyNodeSocketReplaceResponse[]'
    ];
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\Common\DestinyDisplayPropertiesDefinition|null $displayProperties These are the display properties actually used to render the Talent Node. The currently active step's displayProperties are shown.
     *
     * @return $this
     */
     ...
     * Sets damageType
     *
     * @param \Bungie\D1\Model\Destiny\DamageType|null $damageType An enum representing a damage type granted by activating this step, if any.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyNodeActivationRequirement|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyNodeActivationRequirement|null $activationRequirement If the step has requirements for activation (they almost always do, if nothing else than for the Talent Grid's Progression to have reached a certain level), they will be defined here.
     *
     * @return $this
     */
     ...
     * Gets stepGroups
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyTalentNodeStepGroups|null
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyNodeSocketReplaceResponse[]|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyNodeSocketReplaceResponse[]|null $socketReplacements If this step is activated, this will be a list of information used to replace socket items with new Plugs. See DestinyInventoryItemDefinition for more information about sockets and plugs.
     *
     * @return $this
     */
