 ...
 * @link     https://openapi-generator.tech
 */
class DestinyVendorInteractionDefinition implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'replies' => '\Bungie\D1\Model\Destiny\Definitions\DestinyVendorInteractionReplyDefinition[]',
        'vendorCategoryIndex' => 'int',
        'questlineItemHash' => 'int',
        'sackInteractionList' => '\Bungie\D1\Model\Destiny\Definitions\DestinyVendorInteractionSackEntryDefinition[]',
        'uiInteractionType' => 'int',
        'interactionType' => '\Bungie\D1\Model\Destiny\VendorInteractionType',
        'rewardBlockLabel' => 'string',
        'rewardVendorCategoryIndex' => 'int',
        'flavorLineOne' => 'string',
        'flavorLineTwo' => 'string',
        'headerDisplayProperties' => '\Bungie\D1\Model\Destiny\Definitions\Common\DestinyDisplayPropertiesDefinition',
        'instructions' => 'string'
    ];
     ...
     * Gets replies
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyVendorInteractionReplyDefinition[]|null
     */
     ...
     * Sets replies
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyVendorInteractionReplyDefinition[]|null $replies The potential replies that the user can make to the interaction.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyVendorInteractionSackEntryDefinition[]|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyVendorInteractionSackEntryDefinition[]|null $sackInteractionList If this interaction is meant to show you sacks, this is the list of types of sacks to be shown. If empty, the interaction is not meant to show sacks.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\VendorInteractionType|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\VendorInteractionType|null $interactionType The enumerated version of the possible UI hints for vendor interactions, which is a little easier to grok than the hash found in uiInteractionType.
     *
     * @return $this
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\Common\DestinyDisplayPropertiesDefinition|null $headerDisplayProperties The header for the interaction dialog.
     *
     * @return $this
     */
