...
namespace Bungie\D1\Model\Destiny\Definitions\Items;
 ...
 * @link     https://openapi-generator.tech
 */
class DestinyItemPlugDefinition implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'insertionRules' => '\Bungie\D1\Model\Destiny\Definitions\Items\DestinyPlugRuleDefinition[]',
        ...
        'enabledRules' => '\Bungie\D1\Model\Destiny\Definitions\Items\DestinyPlugRuleDefinition[]',
        'uiPlugLabel' => 'string',
        'plugStyle' => '\Bungie\D1\Model\Destiny\PlugUiStyles',
        'isPseudoPlug' => 'bool',
        'plugAvailability' => '\Bungie\D1\Model\Destiny\PlugAvailabilityMode',
        'alternateUiPlugLabel' => 'string',
        'alternatePlugStyle' => '\Bungie\D1\Model\Destiny\PlugUiStyles',
        'isDummyPlug' => 'bool',
        'parentItemOverride' => '\Bungie\D1\Model\Destiny\Definitions\Items\DestinyParentItemOverride'
    ];
     ...
     * Gets insertionRules
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\Items\DestinyPlugRuleDefinition[]|null
     */
     ...
     * Sets enabledRules
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\Items\DestinyPlugRuleDefinition[]|null $enabledRules The rules around whether the plug, once inserted, is enabled and providing its benefits.  The live data DestinyItemPlugComponent.enableFailIndexes will be an index into this array, so you can pull out the failure strings appropriate for the user.
     *
     * @return $this
     */
     ...
     * Gets plugStyle
     *
     * @return \Bungie\D1\Model\Destiny\PlugUiStyles|null
     */
     ...
     * Sets plugStyle
     *
     * @param \Bungie\D1\Model\Destiny\PlugUiStyles|null $plugStyle plugStyle
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\PlugAvailabilityMode|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\PlugAvailabilityMode|null $plugAvailability Indicates the rules about when this plug can be used. See the PlugAvailabilityMode enumeration for more information!
     *
     * @return $this
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\PlugUiStyles|null $alternatePlugStyle The alternate plug of the plug: only applies when the item is in states that only the server can know about and control, unfortunately. See AlternateUiPlugLabel for the related label info.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\Items\DestinyParentItemOverride|null
     */
