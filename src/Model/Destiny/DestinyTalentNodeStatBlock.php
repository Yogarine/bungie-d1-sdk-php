 ...
 * @link     https://openapi-generator.tech
 */
class DestinyTalentNodeStatBlock implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'currentStepStats' => '\Bungie\D1\Model\Destiny\DestinyStat[]',
        'nextStepStats' => '\Bungie\D1\Model\Destiny\DestinyStat[]'
    ];
     ...
     *
     * @param \Bungie\D1\Model\Destiny\DestinyStat[]|null $currentStepStats The stat benefits conferred when this talent node is activated for the current Step that is active on the node.
     *
     * @return $this
     */
