 ...
 * @link     https://openapi-generator.tech
 */
class DestinyTalentNode implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'nodeIndex' => 'int',
        'nodeHash' => 'int',
        'state' => '\Bungie\D1\Model\Destiny\DestinyTalentNodeState',
        'isActivated' => 'bool',
        'stepIndex' => 'int',
        'materialsToUpgrade' => '\Bungie\D1\Model\Destiny\Definitions\DestinyMaterialRequirement[]',
        'activationGridLevel' => 'int',
        'progressPercent' => 'float',
        'hidden' => 'bool',
        'nodeStatsBlock' => '\Bungie\D1\Model\Destiny\DestinyTalentNodeStatBlock'
    ];
     ...
     * Gets state
     *
     * @return \Bungie\D1\Model\Destiny\DestinyTalentNodeState|null
     */
     ...
     * Sets state
     *
     * @param \Bungie\D1\Model\Destiny\DestinyTalentNodeState|null $state An DestinyTalentNodeState enum value indicating the node's state: whether it can be activated or swapped, and why not if neither can be performed.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\Definitions\DestinyMaterialRequirement[]|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\Definitions\DestinyMaterialRequirement[]|null $materialsToUpgrade If the node has material requirements to be activated, this is the list of those requirements.
     *
     * @return $this
     */
     ...
     * Gets nodeStatsBlock
     *
     * @return \Bungie\D1\Model\Destiny\DestinyTalentNodeStatBlock|null
     */
     ...
     * Sets nodeStatsBlock
     *
     * @param \Bungie\D1\Model\Destiny\DestinyTalentNodeStatBlock|null $nodeStatsBlock This property has some history. A talent grid can provide stats on both the item it's related to and the character equipping the item. This returns data about those stat bonuses.
     *
     * @return $this
     */
