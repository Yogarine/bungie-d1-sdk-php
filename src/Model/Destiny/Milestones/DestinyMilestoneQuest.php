 ...
 * @link     https://openapi-generator.tech
 */
class DestinyMilestoneQuest implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'questItemHash' => 'int',
        'status' => '\Bungie\D1\Model\Destiny\Quests\DestinyQuestStatus',
        'activity' => '\Bungie\D1\Model\Destiny\Milestones\DestinyMilestoneActivity',
        'challenges' => '\Bungie\D1\Model\Destiny\Challenges\DestinyChallengeStatus[]'
    ];
     ...
     * Sets status
     *
     * @param \Bungie\D1\Model\Destiny\Quests\DestinyQuestStatus|null $status The current status of the quest for the character making the request.
     *
     * @return $this
     */
     ...
     * Gets activity
     *
     * @return \Bungie\D1\Model\Destiny\Milestones\DestinyMilestoneActivity|null
     */
     ...
     * Sets activity
     *
     * @param \Bungie\D1\Model\Destiny\Milestones\DestinyMilestoneActivity|null $activity *IF* the Milestone has an active Activity that can give you greater details about what you need to do, it will be returned here. Remember to associate this with the DestinyMilestoneDefinition's activities to get details about the activity, including what specific quest it is related to if you have multiple quests to choose from.
     *
     * @return $this
     */
     ...
     * Gets challenges
     *
     * @return \Bungie\D1\Model\Destiny\Challenges\DestinyChallengeStatus[]|null
     */
     ...
     * Sets challenges
     *
     * @param \Bungie\D1\Model\Destiny\Challenges\DestinyChallengeStatus[]|null $challenges The activities referred to by this quest can have many associated challenges. They are all contained here, with activityHashes so that you can associate them with the specific activity variants in which they can be found. In retrospect, I probably should have put these under the specific Activity Variants, but it's too late to change it now. Theoretically, a quest without Activities can still have Challenges, which is why this is on a higher level than activity/variants, but it probably should have been in both places. That may come as a later revision.
     *
     * @return $this
     */
