...
namespace Bungie\D1\Model\Destiny\Entities\Items;
 ...
 * @link     https://openapi-generator.tech
 */
class DestinyItemComponent implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'itemInstanceId' => 'int',
        'quantity' => 'int',
        'bindStatus' => '\Bungie\D1\Model\Destiny\ItemBindStatus',
        'location' => '\Bungie\D1\Model\Destiny\ItemLocation',
        'bucketHash' => 'int',
        'transferStatus' => '\Bungie\D1\Model\Destiny\TransferStatuses',
        'lockable' => 'bool',
        'state' => '\Bungie\D1\Model\Destiny\ItemState',
     ...
     * Gets bindStatus
     *
     * @return \Bungie\D1\Model\Destiny\ItemBindStatus|null
     */
     ...
     * Sets bindStatus
     *
     * @param \Bungie\D1\Model\Destiny\ItemBindStatus|null $bindStatus If the item is bound to a location, it will be specified in this enum.
     *
     * @return $this
     */
     ...
     * Gets location
     *
     * @return \Bungie\D1\Model\Destiny\ItemLocation|null
     */
     ...
     * Sets location
     *
     * @param \Bungie\D1\Model\Destiny\ItemLocation|null $location An easy reference for where the item is located. Redundant if you got the item from an Inventory, but useful when making detail calls on specific items.
     *
     * @return $this
     */
     ...
     * Gets transferStatus
     *
     * @return \Bungie\D1\Model\Destiny\TransferStatuses|null
     */
     ...
     * Sets transferStatus
     *
     * @param \Bungie\D1\Model\Destiny\TransferStatuses|null $transferStatus If there is a known error state that would cause this item to not be transferable, this Flags enum will indicate all of those error states. Otherwise, it will be 0 (CanTransfer).
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \Bungie\D1\Model\Destiny\ItemState|null
     */
     ...
     * Sets state
     *
     * @param \Bungie\D1\Model\Destiny\ItemState|null $state A flags enumeration indicating the transient/custom states of the item that affect how it is rendered: whether it's tracked or locked for example, or whether it has a masterwork plug inserted.
     *
     * @return $this
     */
