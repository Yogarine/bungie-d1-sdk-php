 ...
 * @link     https://openapi-generator.tech
 */
class DestinyItemInstanceComponent implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'damageTypeHash' => 'int',
        'primaryStat' => '\Bungie\D1\Model\Destiny\DestinyStat',
        'itemLevel' => 'int',
        'quality' => 'int',
        'isEquipped' => 'bool',
        'canEquip' => 'bool',
        ...
        'cannotEquipReason' => '\Bungie\D1\Model\Destiny\EquipFailureReason'
    ];
     ...
     * Sets damageType
     *
     * @param \Bungie\D1\Model\Destiny\DamageType|null $damageType If the item has a damage type, this is the item's current damage type.
     *
     * @return $this
     */
     ...
     * Gets primaryStat
     *
     * @return \Bungie\D1\Model\Destiny\DestinyStat|null
     */
     ...
     * Sets primaryStat
     *
     * @param \Bungie\D1\Model\Destiny\DestinyStat|null $primaryStat The item stat that we consider to be \"primary\" for the item. For instance, this would be \"Attack\" for Weapons or \"Defense\" for armor.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\EquipFailureReason|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\EquipFailureReason|null $cannotEquipReason If you cannot equip the item, this is a flags enum that enumerates all of the reasons why you couldn't equip the item. You may need to refine your UI further by using unlockHashesRequiredToEquip and equipRequiredLevel.
     *
     * @return $this
     */
