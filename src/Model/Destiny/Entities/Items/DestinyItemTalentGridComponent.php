 ...
 * @link     https://openapi-generator.tech
 */
class DestinyItemTalentGridComponent implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'talentGridHash' => 'int',
        'nodes' => '\Bungie\D1\Model\Destiny\DestinyTalentNode[]',
        'isGridComplete' => 'bool',
        'gridProgression' => '\Bungie\D1\Model\Destiny\DestinyProgression'
    ];
     ...
     * Gets nodes
     *
     * @return \Bungie\D1\Model\Destiny\DestinyTalentNode[]|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\DestinyProgression|null $gridProgression If the item has a progression, it will be detailed here. A progression means that the item can gain experience. Thresholds of experience are what determines whether and when a talent node can be activated.
     *
     * @return $this
     */
