 ...
 * @link     https://openapi-generator.tech
 */
class DestinyItemSocketState implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'plugObjectives' => '\Bungie\D1\Model\Destiny\Quests\DestinyObjectiveProgress[]',
        'reusablePlugs' => '\Bungie\D1\Model\Destiny\Sockets\DestinyItemPlug[]'
    ];
     ...
     * Sets plugObjectives
     *
     * @param \Bungie\D1\Model\Destiny\Quests\DestinyObjectiveProgress[]|null $plugObjectives Sometimes, Plugs may have objectives: generally, these are used for flavor and display purposes. For instance, a Plug might be tracking the number of PVP kills you have made. It will use the parent item's data about that tracking status to determine what to show, and will generally show it using the DestinyObjectiveDefinition's progressDescription property. Refer to the plug's itemHash and objective property for more information if you would like to display even more data.
     *
     * @return $this
     */
     ...
     * Gets reusablePlugs
     *
     * @return \Bungie\D1\Model\Destiny\Sockets\DestinyItemPlug[]|null
     */
