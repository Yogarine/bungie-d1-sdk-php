 ...
 * @link     https://openapi-generator.tech
 */
class DestinyCharacterRenderComponent implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'customDyes' => '\Bungie\D1\Model\Destiny\DyeReference[]',
        'customization' => '\Bungie\D1\Model\Destiny\Character\DestinyCharacterCustomization',
        'peerView' => '\Bungie\D1\Model\Destiny\Character\DestinyCharacterPeerView'
    ];
     ...
     * Gets customDyes
     *
     * @return \Bungie\D1\Model\Destiny\DyeReference[]|null
     */
     ...
     * Sets customDyes
     *
     * @param \Bungie\D1\Model\Destiny\DyeReference[]|null $customDyes Custom dyes, calculated by iterating over the character's equipped items. Useful for pre-fetching all of the dye data needed from our server.
     *
     * @return $this
     */
     ...
     * Gets customization
     *
     * @return \Bungie\D1\Model\Destiny\Character\DestinyCharacterCustomization|null
     */
     ...
     * Sets customization
     *
     * @param \Bungie\D1\Model\Destiny\Character\DestinyCharacterCustomization|null $customization This is actually something that Spasm.js *doesn't* do right now, and that we don't return assets for yet. This is the data about what character customization options you picked. You can combine this with DestinyCharacterCustomizationOptionDefinition to show some cool info, and hopefully someday to actually render a user's face in 3D. We'll see if we ever end up with time for that.
     *
     * @return $this
     */
     ...
     * Gets peerView
     *
     * @return \Bungie\D1\Model\Destiny\Character\DestinyCharacterPeerView|null
     */
     ...
     * Sets peerView
     *
     * @param \Bungie\D1\Model\Destiny\Character\DestinyCharacterPeerView|null $peerView A minimal view of:  - Equipped items  - The rendering-related custom options on those equipped items  Combined, that should be enough to render all of the items on the equipped character.
     *
     * @return $this
     */
