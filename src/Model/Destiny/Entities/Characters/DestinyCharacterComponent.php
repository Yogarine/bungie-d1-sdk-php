 ...
 * @link     https://openapi-generator.tech
 */
class DestinyCharacterComponent implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'genderHash' => 'int',
        'classHash' => 'int',
        'raceType' => '\Bungie\D1\Model\Destiny\DestinyRace',
        'classType' => '\Bungie\D1\Model\Destiny\DestinyClass',
        'genderType' => '\Bungie\D1\Model\Destiny\DestinyGender',
        'emblemPath' => 'string',
        'emblemBackgroundPath' => 'string',
        'emblemHash' => 'int',
        'emblemColor' => '\Bungie\D1\Model\Destiny\Misc\DestinyColor',
        'levelProgression' => '\Bungie\D1\Model\Destiny\DestinyProgression',
     ...
     * Sets membershipType
     *
     * @param \Bungie\D1\Model\BungieMembershipType|null $membershipType membershipType tells you the platform on which the character plays. Examine the BungieMembershipType enumeration for possible values.
     *
     * @return $this
     */
     ...
     * Gets raceType
     *
     * @return \Bungie\D1\Model\Destiny\DestinyRace|null
     */
     ...
     * Sets raceType
     *
     * @param \Bungie\D1\Model\Destiny\DestinyRace|null $raceType Mostly for historical purposes at this point, this is an enumeration for the character's race.  It'll be preferable in the general case to look up the related definition: but for some people this was too convenient to remove.
     *
     * @return $this
     */
     ...
     * Sets classType
     *
     * @param \Bungie\D1\Model\Destiny\DestinyClass|null $classType Mostly for historical purposes at this point, this is an enumeration for the character's class.  It'll be preferable in the general case to look up the related definition: but for some people this was too convenient to remove.
     *
     * @return $this
     */
     ...
     * Gets genderType
     *
     * @return \Bungie\D1\Model\Destiny\DestinyGender|null
     */
     ...
     * Sets genderType
     *
     * @param \Bungie\D1\Model\Destiny\DestinyGender|null $genderType Mostly for historical purposes at this point, this is an enumeration for the character's Gender.  It'll be preferable in the general case to look up the related definition: but for some people this was too convenient to remove. And yeah, it's an enumeration and not a boolean. Fight me.
     *
     * @return $this
     */
     ...
     * Sets emblemColor
     *
     * @param \Bungie\D1\Model\Destiny\Misc\DestinyColor|null $emblemColor A shortcut for getting the background color of the user's currently equipped emblem without having to do a DestinyInventoryItemDefinition lookup.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\D1\Model\Destiny\DestinyProgression|null
     */
     ...
     *
     * @param \Bungie\D1\Model\Destiny\DestinyProgression|null $levelProgression The progression that indicates your character's level. Not their light level, but their character level: you know, the thing you max out a couple hours in and then ignore for the sake of light level.
     *
     * @return $this
     */
