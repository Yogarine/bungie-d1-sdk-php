...
namespace Bungie\D1\Model\Destiny\Quests;
 ...
 * @link     https://openapi-generator.tech
 */
class DestinyQuestStatus implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'questHash' => 'int',
        'stepHash' => 'int',
        'stepObjectives' => '\Bungie\D1\Model\Destiny\Quests\DestinyObjectiveProgress[]',
        'tracked' => 'bool',
        'itemInstanceId' => 'int',
        'completed' => 'bool',
        'redeemed' => 'bool',
     ...
     * Sets stepObjectives
     *
     * @param \Bungie\D1\Model\Destiny\Quests\DestinyObjectiveProgress[]|null $stepObjectives A step can have multiple objectives. This will give you the progress for each objective in the current step, in the order in which they are rendered in-game.
     *
     * @return $this
     */
