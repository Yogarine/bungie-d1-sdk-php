 ...
 * @link     https://openapi-generator.tech
 */
class InlineObject3 implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
     ...
     * Sets itemId
     *
     * @param int|null $itemId A valid instanceId of an item to lock/unlock.
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param bool|null $state The item lock state, true to lock, false to unlock.
     *
     * @return $this
     */
