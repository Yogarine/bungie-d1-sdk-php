 ...
 * @link     https://openapi-generator.tech
 */
class InlineObject4 implements \Bungie\D1\Model\ModelInterface, ArrayAccess
{
     ...
     *
     * @param int|null $destinyMembershipId Destiny membership ID.
     *
     * @return $this
     */
     ...
     * Sets itemId
     *
     * @param int|null $itemId The unique item hash of the quest item.
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param bool|null $state true = tracked, false = not-tracked
     *
     * @return $this
     */
