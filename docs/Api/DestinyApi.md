...
[**getHistoricalStatsDefinition**](DestinyApi.md#getHistoricalStatsDefinition) | **GET** /Destiny/Stats/Definition/ | 
...
try {
    ...
    echo 'Exception when calling DestinyApi->getVaultSummary: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling DestinyApi->getVendorForCurrentCharacter: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling DestinyApi->getVendorForCurrentCharacterWithMetadata: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling DestinyApi->getVendorItemDetailForCurrentCharacter: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling DestinyApi->getVendorItemDetailForCurrentCharacterWithMetadata: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling DestinyApi->getVendorSummariesForCurrentCharacter: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling DestinyApi->searchDestinyPlayer: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling DestinyApi->setItemLockState: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling DestinyApi->setQuestTrackedState: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling DestinyApi->transferItem: ', $e->getMessage(), PHP_EOL;
}
?>
```
