...
**modeType** | [**\Bungie\D1\Model\Destiny\HistoricalStats\Definitions\DestinyActivityModeType**](DestinyActivityModeType.md) | The Enumeration value for this Activity Mode. Pass this identifier into Stats endpoints to get aggregate stats for this mode. | [optional] 
**activityModeCategory** | [**\Bungie\D1\Model\Destiny\DestinyActivityModeCategory**](DestinyActivityModeCategory.md) | The type of play being performed in broad terms (PVP, PVE) | [optional] 
