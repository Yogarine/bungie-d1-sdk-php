...
------------ | ------------- | ------------- | -------------
**itemList** | [**\Bungie\D1\Model\Destiny\Definitions\DestinyItemSetBlockEntryDefinition[]**](DestinyItemSetBlockEntryDefinition.md) | A collection of hashes of set items, for items such as Quest Metadata items that possess this data. | [optional] 
